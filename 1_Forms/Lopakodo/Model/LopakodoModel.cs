...
namespace Lopakodo.Model
{
    ...
    public class LopakodoModel
    {
        ...
        public async Task NewGame()
        {
            ...
            switch (SelectedField)
            {
                case LevelEnum.Basement:
                    _gameField = await _gameFieldData.LoadAsync("../../../Maps/basement.txt");
                    break;
                case LevelEnum.Showers:
                    _gameField = await _gameFieldData.LoadAsync("../../../Maps/showers.txt");
                    break;
                case LevelEnum.School:
                    _gameField = await _gameFieldData.LoadAsync("../../../Maps/school.txt");
                    break;
            }
        ...
        private void PlayerSpotted()
        {
            ...
            if (spotted) { GameOver(this, new LopakodoEventArgs(false)); }
        }
        ...
        private void PlayerEscaped()
        {
            ...
            {
                if (GameOver != null) { GameOver(this, new LopakodoEventArgs(true)); }
            }
        }
    }
}
